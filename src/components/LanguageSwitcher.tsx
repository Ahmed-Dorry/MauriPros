...
// 1. تعريف الخصائص عشان نقبل تغيير الشكل (زرار كامل أو أيقونة)
...
export default function LanguageSwitcher({ variant = "default" }: LanguageSwitcherProps) {
  ...
  // 💡 State لمعرفة هل اليوزر من أمريكا ولا لأ 
  ...
  // 💡 أول ما الكومبوننت يحمل، يتأكد من كوكي أمريكا
  useEffect(() => {
  ...
  // 🚨 اللمسة السحرية: لو اليوزر من أمريكا، متعملش ريندر لأي حاجة (إخفاء تام) 🚨
  if (isUSUser) return null;
